...
QHash<int, QByteArray> TransferModel::roleNames() const {
    ...
    roles[TransferModelItem::TM_NAME]   = "name";
    roles[TransferModelItem::TM_SIZE]   = "size";
    roles[TransferModelItem::TM_TYPE]   = "type";
    roles[TransferModelItem::TM_PROGRESS]="progress";
    roles[TransferModelItem::TM_STATUS] = "status";
    roles[TransferModelItem::TM_SEEDS]  = "seeds";
    roles[TransferModelItem::TM_PEERS]  = "peers";
    roles[TransferModelItem::TM_DLSPEED]= "dl_speed";
    roles[TransferModelItem::TM_UPSPEED]= "up_speed";
    roles[TransferModelItem::TM_HASH]   = "hash";
    roles[TransferModelItem::TM_ETA]    = "eta";
    roles[TransferModelItem::TM_RATIO]  = "ratio";
    roles[TransferModelItem::TM_ADD_DATE]= "add_date";
