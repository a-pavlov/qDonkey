...
Dialog {
    ...
    text: qsTr("This application for eDonkey2000 networks.
More information about KAD support,development and future plans at https://github.com/a-pavlov/qdonkey/wiki.
You can help the development by give a good rating to the app in Google Play or clicking on an ad unit")
    hasActions: true
